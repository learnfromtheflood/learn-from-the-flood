const tracks = [
  ...
  { section: 2, number: '2.1', title: 'Every Animal as Food', file: 'audio/2.1.Every-Animal-as-Food.mp3', duration: 91.38, commentary: [
  ...
  { section: 2, number: '2.2', title: 'Tools', file: 'audio/2.2.Tools.mp3', duration: 146.10, commentary: [
  ...
  { section: 2, number: '2.3', title: 'Farming', file: 'audio/2.3.Farming.mp3', duration: 115.02, commentary: [
  ...
  { section: 2, number: '2.6', title: 'Abundant Knowledge', file: 'audio/2.6.Abundant-Knowledge.mp3', duration: 376.14, videoUrl: 'https://drive.google.com/file/d/1ksgC7XlY-0dVCBqwo9AENMbqlrTAiqgN/view', videoLabel: 'Watch the concluding video', commentary: [
    'An article dated 1980 entitled "How Chips Make Your Life Easier" featured these comments: "In offices, \'desk-sized computers will become nearly as common as typewriters,\' predicts Scientific American. They will store details of information needed for each person’s job and will be far easier to handle than bulky files, ledgers and reference books. \'Word-processors\' are an application of chip technology to typewriting. They take over a number of the repetitious aspects of typing... Two or three such devices can do the work of many more typists."',
    ...
    'Today, the rapid development of AI has made it easier and quicker to translate, helping us understand one another more effectively. But speaking a single language naturally would have favored incredible achievements in arts and sciences, requiring the collective effort of many people with diverse skills. Additionally, the long life spans that most people enjoyed back then meant they could continue to build upon what they had learned over centuries.Throughout the pre-Flood ages, a variety of industries developed. There were forges for "every sort of tool of copper and iron." Does our day reflect a similarly rapid change in industry?',
    'We certainly live in a highly industrial, technological age. Back then, accumulated knowledge made it possible for successive generations to develop specialties like metallurgy, agronomy, rearing sheep and cattle, writing, and the fine arts. Jubal, for example, was "the founder of all those who handle the harp and the pipe." Civilization developed extensively.Yet, it all came to a sudden end. What happened? Despite their advancements and efforts to build a better world, sin and imperfection remained. The influence of wicked spirit creatures caused widespread trouble, and true worship was not abundant. Are there similarities to our day?',
    'We are living in the time of the end, the last days. Since 1914, those same wicked spirit creatures have been confined to the earth, knowing they have only a short period of time left. The beautiful difference today, however, is that true knowledge has become abundant, and soon those wicked influences will be gone. Please read the final scripture for today\'s tour at Daniel chapter 12, verse 4, where it says: "As for you, Daniel, keep the words secret, and seal up the book until the time of the end. Many will rove about, and the true knowledge will become abundant."',
